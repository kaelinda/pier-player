...
- [ ] **Step 1: Write failing migration and synchronizable-Keychain tests**
...
- [ ] **Step 3: Implement the non-secret model and migration**
...
- [ ] **Step 1: Write failing model, identity, and store tests**
...
- [ ] **Step 3: Implement the transport boundary and coordinator**
...
- [ ] **Step 1: Write failing CloudKit mapping tests**
...
- [ ] **Step 3: Implement the CloudKit adapter**
...
- [ ] **Step 3: Implement app source integration**
...
- [ ] **Step 4: Run focused and rendering tests**
...
- [ ] **Step 3: Implement progress lifecycle**
...
- [ ] **Step 3: Inspect privacy-sensitive output**
...
- [ ] **Step 4: Record the live acceptance limitation**
...
- [ ] **Step 5: Commit final plan status or corrections**
